...
const data = [
  {
    ...
    desc: `Data Analytics and Visualisation`,
  },
  {
  ...
  },
  {
    ...
    desc: "Data Integration and Management",
  },
  {
    img: "/services/overview/verified.webp",
    desc: "Business Intelligence Solutions",
  },
  {
    img: "/services/overview/first-prize.webp",
    desc: "Customised Data Solutions",
  },
  {
    img: "/services/overview/laptop.webp",
...
const ServiceOfferingCardData = [
  {
    desc: "Our advanced machine-learning algorithms help you analyse historical data, identify patterns, and make accurate predictions. ",
    list: ["Predictive Analytics", "Prescriptive Analytics"],
  },
  {
    desc: "We offer seamless data integration and management services, allowing you to combine different data sources and formats into one cohesive and reliable infrastructure. ",
    list: ["Data Integration"],
  },
  {
    desc: "Our principle of fail fast to learn faster is enabled by an ecosystem of experimentation. Our AI Labs for innovative opportunities, enables us along with partners or clients to co-innovate..",
    list: [
...
export default function DataAndInsights() {
  ...
  return (
    <>
      <Helmet>
        <title>Affirmity Corp - Data and Insights</title>
        <meta
          name="description"
          content="Transforming Raw Data into Actionable Intelligence for Informed Decision-Making."
        />
      </Helmet>
          ...
          <div className="w-full h-full max-w-7xl  flex flex-col pt-20 md:py-20  px-6  md:px-10  min-[1280px]:px-4   ">
            <div className="w-full  flex flex-col items-start  justify-start h-full gap-4  md:gap-10  ">
              ...
              <div className="flex w-fit gap-3 md:mt-8">
                ...
                <div className="w-fit flex gap-2 justify-center items-center">
                  <span className="text-xs md:text-sm">Data & Insights</span>
              ...
              <div className=" w-full flex flex-col gap-4  justify-center items-center  h-full  ">
                ...
                <p className="  md:text-3xl font-bold w-full md:w-[80%] text-center text-orange-50">
                  Empowering Organisations through Advanced Data and Insights
                </p>
                <p className=" md:text-xl w-full  md:w-2/3 text-center text-slate-300">
                  Transforming Raw Data into Actionable Intelligence for
        ...
        >
          <div className="w-full h-full  flex flex-col pt-20 md:py-20  px-6  max-w-7xl    md:px-10  min-[1280px]:px-4    gap-8 ">
            ...
            <p className="md:text-[18px] text-center">
              Affirmity stands as a reliable partner for organisations seeking
              to unlock the potential of their data, providing insights with a
              transformative approach to data utilisation for sustainable
              business success.
            </p>

            <span className="md:text-[18px] text-center">
              Affirmity Corp - Your Trusted Partner in Navigating the Data
              Landscape for Business Excellence.
            </span>
    ...
    <div id="platforms" className="w-full   flex justify-center ">
      <div className="w-full min-h-full  flex flex-col pt-20 md:py-20  px-6 max-w-7xl   md:px-10  min-[1280px]:px-4  gap-14 ">
        ...
        <div className="w-full flex justify-center gap-10">
          <Card
            title="Seeker Analytics"
            desc="Seeker is a system that utilises facial recognition technology to monitor the movement of people within a specific area."
